# -*- coding: utf-8 -*-
"""
Created on Mon Jul 29 16:28:00 2024
...
# Enlever les genes d'AEGIS qu'il n'y a pas dans CRUKPAP
...
# Filtrer les colonnes de df_genes pour ne garder que celles présentes dans df_genes_CRUKPAP
df_genes_AEGIS = df_genes_AEGIS.loc[:, df_genes_AEGIS.columns.isin(colonnes_CRUKPAP)]

print(df_genes_AEGIS.head())
print(df_genes_AEGIS.shape)
...
## ex : ([1, 2, 3, 4], [5]), ([1, 2, 3, 5], [4])... et on les test tous (5)
    ...
    logistique2 = LogisticRegression(penalty='elasticnet', solver='saga', C=best_C, l1_ratio = 0.5, max_iter=8000)
